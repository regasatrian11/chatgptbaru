...
export default function TypingIndicator() {
  ...
  return (
    <div className="flex items-end gap-3 mb-4">
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl rounded-bl-md px-4 py-3 shadow-xl border border-white/30 relative">
      ...
      <span className="text-xs text-gray-500 mb-1 ml-1 font-medium">{t('typing')}</span>
    </div>
  );
}